...
<div class="language-plain line-numbers-mode" data-highlighter="shiki" data-ext="plain" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-plain"><span class="line"><span>python -m vllm.entrypoints.openai.api_server \</span></span>
<span class="line"><span>    --model "Qwen/Qwen3-32B-Instruct" \</span></span>
...
<span class="line"><span>client = openai.OpenAI(</span></span>
<span class="line"><span>    base_url="http://localhost:8000/v1",</span></span>
<span class="line"><span>    api_key="vllm"</span></span>
<span class="line"><span>)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>response = client.chat.completions.create(</span></span>
<span class="line"><span>    model="Qwen/Qwen3-32B-Instruct",</span></span>
<span class="line"><span>    messages=[{"role": "user", "content": "你好，请介绍一下vLLM。"}],</span></span>
<span class="line"><span>    max_tokens=500</span></span>
<span class="line"><span>)</span></span>
...
<p>Python</p>
<div class="language-plain line-numbers-mode" data-highlighter="shiki" data-ext="plain" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-plain"><span class="line"><span>from vllm import LLM, SamplingParams</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 准备一批需要生成的Prompt</span></span>
<span class="line"><span>prompts = [</span></span>
<span class="line"><span>    "你好，请介绍一下vLLM。",</span></span>
<span class="line"><span>    "量子计算的基本原理是什么？"</span></span>
<span class="line"><span>]</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 定义采样参数</span></span>
<span class="line"><span>sampling_params = SamplingParams(temperature=0.7, top_p=0.95, max_tokens=500)</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 初始化LLM引擎</span></span>
<span class="line"><span>llm = LLM(model="Qwen/Qwen3-32B-Instruct")</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 执行批处理生成</span></span>
...
<span class="line"><span>    print(f"Prompt: {prompt}\nGenerated: {generated_text}\n")</span></span></code></pre>
