...
<div class="language-plain line-numbers-mode" data-highlighter="shiki" data-ext="plain" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-plain"><span class="line"><span>import torch</span></span>
...
<span class="line"><span>    print(f"\n当 x = 15.0 时, 模型的预测值 y = {predicted_y.item():.4f}")</span></span></code></pre>
...
<p><strong>总结</strong>：PyTorch就是那个底层但无比强大的“Spring框架”。它赋予了开发者完全的控制权，虽然写起来可能比更高层封装的库（<a href="http://xn--Kerasfast-k99p786e.ai" target="_blank" rel="noopener noreferrer">如Keras或fast.ai</a>）要“繁琐”一些，但正是这种透明度和灵活性，使其成为驱动当今几乎所有前沿AI研究和应用（包括大语言模型）的首选引擎。</p>
</div></template>
