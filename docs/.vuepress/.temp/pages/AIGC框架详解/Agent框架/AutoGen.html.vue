...
<span class="line"><span>from autogen import AssistantAgent, UserProxyAgent, config_list_from_json</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 0. 加载LLM配置</span></span>
<span class="line"><span># 您可以从一个JSON文件中加载，或者直接在代码中设置</span></span>
<span class="line"><span># 示例：config_list = [{"model": "gpt-4o", "api_key": "YOUR_API_KEY"}]</span></span>
<span class="line"><span>config_list = config_list_from_json(env_or_file="OAI_CONFIG_LIST")</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 1. 创建助理Agent (AI工作者)</span></span>
<span class="line"><span>assistant = AssistantAgent(</span></span>
<span class="line"><span>    name="assistant",</span></span>
<span class="line"><span>    llm_config={</span></span>
<span class="line"><span>        "config_list": config_list,</span></span>
<span class="line"><span>        "temperature": 0</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>)</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 2. 创建用户代理Agent (人类代理/代码执行者)</span></span>
<span class="line"><span>user_proxy = UserProxyAgent(</span></span>
<span class="line"><span>    name="user_proxy",</span></span>
<span class="line"><span>    human_input_mode="NEVER",  # 在这个例子中，我们不寻求人类输入</span></span>
<span class="line"><span>    max_consecutive_auto_reply=10,</span></span>
<span class="line"><span>    is_termination_msg=lambda x: x.get("content", "").rstrip().endswith("TERMINATE"),</span></span>
<span class="line"><span>    code_execution_config={</span></span>
<span class="line"><span>        "work_dir": "coding",  # 指定一个工作目录来保存和执行代码</span></span>
<span class="line"><span>        "use_docker": False,   # 为了简单，我们不使用Docker。生产环境建议开启。</span></span>
<span class="line"><span>    },</span></span>
<span class="line"><span>    llm_config={ "config_list": config_list }</span></span>
<span class="line"><span>)</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 3. 发起任务</span></span>
<span class="line"><span># user_proxy代表人类向assistant发起一个对话</span></span>
<span class="line"><span>user_proxy.initiate_chat(</span></span>
<span class="line"><span>    assistant,</span></span>
<span class="line"><span>    message="""</span></span>
<span class="line"><span>    What is the date today? Compare the year-to-date gain for META and TESLA.</span></span>
<span class="line"><span>    (今天是几号？对比一下META和TESLA从年初至今的股价涨幅。)</span></span>
<span class="line"><span>    """</span></span>
