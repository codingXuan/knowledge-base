...
export default defineUserConfig({
    ...
    theme: hopeTheme({
        ...
        navbar: [
            ...
            { text: "管理随笔", link: "/management/", icon: "people-roof" },
            { text: "技术随笔", link: "/tech/", icon: "code" },
        ],
            ...
            "/management/": [
                {
                    text: "开篇：我的管理哲学",
                    icon: "book",
                    link: "/management/" // 指向 management/README.md
                },
                {
                    text: "一、项目启动与规划",
                    icon: "compass-drafting",
                    prefix: "/management/planning/",
                    collapsible: true,
                    children: [
                        { text: "WBS：工作分解结构", link: "wbs.md" },
                        { text: "估算方法：如何科学做预算", link: "estimation.md" },
                        { text: "干系人分析：识别你的“盟友”与“对手”", link: "stakeholder-analysis.md" },
                        { text: "风险管理：从救火到预报", link: "risk-management.md" },
                    ],
                },
                {
                    text: "二、敏捷执行与监控",
                    icon: "person-running",
                    prefix: "/management/execution/",
                    collapsible: true,
                    children: [
                        { text: "敏捷核心：Scrum框架精讲", link: "scrum.md" },
                        { text: "进度跟踪：燃尽图与看板", link: "tracking.md" },
                        { text: "变更管理：如何应对“需求变更”", link: "change-management.md" },
                        { text: "会议管理：开一场高效的项目会", link: "meeting-management.md" },
                    ],
                },
                {
                    text: "三、团队协作与效能",
                    icon: "people-group",
                    prefix: "/management/team-efficiency/",
                    collapsible: true,
                    children: [
                        { text: "角色协同：PM与PDM的共舞", link: "pm-pdm-collaboration.md" },
                        { text: "目标管理：OKR的设定与追踪", link: "okr.md" },
                        { text: "研发效能：DORA Metrics详解", link: "dora-metrics.md" },
                        { text: "领导力：技术总监的管理杠杆", link: "leadership.md" },
                    ],
                },
                {
                    text: "四、项目收尾与复盘",
                    icon: "box-archive",
                    prefix: "/management/closing/",
                    collapsible: true,
                    children: [
                        { text: "项目复盘：从经验到方法论", link: "retrospective.md" },
                        { text: "知识沉淀：构建团队的最佳实践", link: "knowledge-management.md" },
                    ],
                },
            ],
