...
| 高级索引 (Advanced Indexing) | 1. 父文档检索器 (Parent Document Retriever)    2. 多表示索引 (Multi-Representation Indexing) | 1. 检索到的上下文太短，LLM理解不全面。   2. 用户问题角度多变，单一向量无法覆盖。 | 1. 当需要为LLM提供更完整上下文时。   2. 当文档包含**摘要、标题、表格**等多种形式的内容时。 |
